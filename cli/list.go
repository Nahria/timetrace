...
func listRecordsCommand(t *core.Timetrace) *cobra.Command {
	...
	listRecords := &cobra.Command{
		Use:   "records {<YYYY-MM-DD>|today|yesterday|last-month|current-month}",
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			out.Table([]string{"#", "Key", "Project", "Start", "End", "Billable", "Description", "Tags"}, rows, footer)
		},
	}
